    ...
    <div className="pb-20 pt-10">
      ...
      <div className="flex justify-center relative z-10">
        <div className="max-w-[89vw] md:max-w-2xl lg:max-w-[60-vw] flex flex-col items-center justify-center">
          <img
            className="w-[14rem] h-[14rem] rounded-full border-[4px] border-[#008c8c] mb-10"
            src="j.png"
            alt="profile pic"
          />

          <h2 className="uppercase tracking-widest text-sm text-center text-blue-100 max-w-80">
            Jeff Jackson Munyigi <br />
            <span className="text-xs text-purple lowercase">
              <a
                href="mailto:jeffmunyigi@gmail.com"
                className="hover:underline"
              >
                jeffmunyigi@gmail.com
              </a>
              <br />
              <a href="tel:+254742422990" className="hover:underline">
                +254742422990
              </a>
            </span>
          </h2>
