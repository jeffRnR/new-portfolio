...
const RecentProjects = () => {
  return (
    <div className='py-20' id='projects'>
        ...
        <div className='flex flex-wrap items-center justify-center p-4 gap-x-20 gap-y-2 mt-4'>
                    ...
                    <PinContainer title={link} href={link}>
                        <div className="relative flex items-center justify-center sm:w-96 w-[80vw] overflow-hidden h-[20vh] lg:h-[30vh] mb-10 rounded-2xl">
                            ...
                            <img 
                                src={img} 
                                alt={title} 
                                className='z-10 absolute bottom-0 bg-cover object-fill justify-center'
                            />
                        </div>
                        <h1 className='font-bold lg:text-2xl md:text-xl text-base line-clamp1'>
                            {title}
                        </h1>
                        <p className='lg:text-xl lg:font-norma font-light text-sm line-clamp-2'>
                            {des}
                        </p>
